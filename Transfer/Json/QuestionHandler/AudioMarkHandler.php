...
/**
 * @DI\Service("ujm.exo.audiomark_handler")
 * @DI\Tag("ujm.exo.question_handler")
 */
class AudioMarkHandler implements QuestionHandlerInterface
{
    private $om;
    ...
    {
        return 'application/x.audiomark+json';
    }
    ...
    {
        return InteractionAudioMark::TYPE;
    }
